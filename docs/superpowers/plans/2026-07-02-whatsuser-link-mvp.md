...
- [x] **Step 1: Generate the scaffold in a temp directory**
...
- [x] **Step 2: Remove the scaffold's own git repo (we already have one)**

```bash
rm -rf /root/whatsuser-link-scaffold/.git
```

- [x] **Step 3: Merge scaffold into the real project directory**
...
- [x] **Step 4: Install dependencies and verify dev server boots**
...
- [x] **Step 1: Initialize shadcn/ui with defaults**
...
- [x] **Step 2: Add the base components used by the generator**
...
- [x] **Step 3: Install remaining runtime dependencies**
...
- [x] **Step 2: Write `types/whatsapp.ts`**
...
- [x] **Step 3: Write `.env.local.example`**
...
- [x] **Step 1: Install Vitest and the tsconfig-paths plugin**
...
- [x] **Step 4: Write the failing test — `utils/validate-username.test.ts`**
...
- [x] **Step 6: Implement `utils/validate-username.ts`**
...
- [x] **Step 1: Write the failing test — `lib/whatsapp/generateLink.test.ts`**
...
- [x] **Step 3: Implement `lib/whatsapp/generateLink.ts`**
...
- [x] **Step 1: Write the failing test — `services/link-service.test.ts`**
...
- [x] **Step 3: Implement `services/link-service.ts`**
...
- [x] **Step 1: Implement `components/theme-provider.tsx`**
...
- [x] **Step 2: Implement `components/theme-toggle.tsx`**
...
- [x] **Step 1: Rewrite `app/layout.tsx`**
...
- [x] **Step 5: Manual smoke test in browser**
...
- [x] **Step 6: Final commit (if any fixes were needed during smoke test)**
