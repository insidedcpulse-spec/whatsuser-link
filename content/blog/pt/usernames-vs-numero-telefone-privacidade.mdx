...
- **Pequenos negócios e empresas** que utilizam a [WhatsApp Business Platform](/pt/glossary/business-platform) para automação e pretendem separar o número pessoal da identidade corporativa.
