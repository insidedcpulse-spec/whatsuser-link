...
export default async function BlogPostPage({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between">
      <main className="flex w-full flex-col items-center px-4 py-12 md:py-16">
        ...
        <article className="mt-8 flex w-full max-w-[720px] flex-col">
          ...
          <div className="mt-12 flex flex-col items-center gap-3 rounded-2xl border bg-card p-6 text-center shadow-xs">
            <p className="font-medium text-foreground">{t("ctaText")}</p>
